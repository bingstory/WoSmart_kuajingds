# WoShop跨境电商带货商城系统源码，APP+小程序+H5（全开源无加密），后端使用ThinkPHP5框架开发，前端采用uni-app框架，已做分包处理，支持负载均衡部署。
> #### 该源码由WoShop开发团队（武汉一一零七科技有限公司）长期维护，持续迭代更新。
``` 
源码不分初级版和高级版，此源码包含WoShop跨境电商所有功能，后续每次迭代更新的部分也都会发出来！
```
如需了解源码，请联系QQ：2487937004 微信：17343366408


#### 介绍
WoShop跨境电商，包含APP端、小程序端、H5端，后端使用ThinkPHP5框架开发，前端采用uni-app框架，已做分包处理，支持负载均衡部署。
...
WoShop跨境电商系统可以对接国际通用支付方式，有效解决了用户跨国际支付问题
...
5.获取WoShop技术社区会员权限，无限浏览付费技术文章；

#### 特别声明
您通过官方渠道获取到的WoShop跨境电商源码仅供您个人或您公司在法律允许的范围内使用，如果您存在以下情形之一，您将会被踢出售后群并被取消WoShop跨境电商使用资格：
1. 将WoShop跨境电商源码分享给他人。
2. 将WoShop跨境电商源码用于违法犯罪。
3. 您可基于源码为您的客户做安装部署或二次开发，但禁止包含但不限于上传到互联网平台、线上或线下传播、转让、倒卖WoShop跨境电商源码等行为。
...
版权所有Copyright © 2015-2020 by WoShop跨境电商 (https://www.s1107.com)

All rights reserved。

WoShop跨境电商著作权所有者为武汉一一零七科技有限公司。  
